    ...
    <div class="container-fluid mx-2">
        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-3 border p-4 info bg-white ms-2 my-2 rounded" >
                ...
                @endif
                <form action="{{ Route('update.staff', ['id' => $staff->id ]) }}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="staffName" value="{{ $staff->staffName }}" placeholder="Enter Name">
                    </div><br>
                    <div class="form-group">
                        <label for="">Address of this Staff</label>
                        <input type="number" class="form-control" name="staffAddress" value="{{ $staff->staffAddress }}" placeholder="Enter Age">
                    </div><br>
                    <div class="form-group">
                        <label for="">Email of this Staff</label>
                        <input type="text" class="form-control" name="email" value="{{ $staff->email }}" placeholder="Enter Breed">
                    </div><br>
                    <div class="form-group">
                        <label for="">Phone Number of this Staff</label>
                        <input type="text" class="form-control" name="phoneNumber" value="{{ $staff->phoneNumber }}" placeholder="Enter Gender">
                    </div><br>
                    <div class="form-group">
                        <label for="">Gender of this Staff</label>
                        <input type="text" class="form-control" name="gender" value="{{ $staff->gender }}" placeholder="Enter Gender">
                    </div><br>
