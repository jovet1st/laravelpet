    ...
    <div class="container-fluid mx-2">
        ...
        <div class="row d-flex justify-content-center align-items-center">
            <div class="col-3 border p-4 info bg-white ms-2 my-2 rounded" >
                ...
                @endif
                <form action="{{ Route('store.pets') }}" method="post">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="petName" placeholder="Enter Name">
                    </div><br>
                    <div class="form-group">
                        <label for="">Age of this pet</label>
                        <input type="number" class="form-control" name="petAge" placeholder="Enter Age">
                    </div><br>
                    <div class="form-group">
                        <label for="">Breed of this pet</label>
                        <input type="text" class="form-control" name="petBreed" placeholder="Enter Breed">
                    </div><br>
                    <div class="form-group">
                        <label for="">Gender of this pet</label>
                        <input type="text" class="form-control" name="petGender" placeholder="Enter Gender">
                    </div><br>
